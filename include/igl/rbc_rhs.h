...
#ifndef IGL_RBC_RHS_H
#define IGL_RBC_RHS_H
...
namespace igl
{
  // RBC_RHS build right-hand side constructor of global poisson solve for
  // various rbc energies
  // Inputs:
